                    ...
                    <div class="d-flex flex-wrap mb-5">
                        @foreach ($blogs as $blog)
                            <div class="card card-primary0 mr-3 mb-5 mt-5" style="width: 24rem">
                                <div class="card-body">
                                    <a href="{{ $blog->fullImage }}" data-fancybox="gallery2" class="rounded-lg"><img
                                            class="img-fluid w-full" style="height: 65%;" src="{{ $blog->fullImage }}"
                                            alt="Post Image"></a>
                                    ...
                                    <div class="row pt-3">
                                        ...
                                        <div class="col text-right">
                                            <a href="javascript:void(0);" class="text-danger"
                                                onclick="deleteData('blog',{{ $blog->id }})">
