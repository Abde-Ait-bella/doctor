                ...
                <div class="p-4 m-3">
                    ...
                    <form action="{{ url('pharmacy_verify_otp') }}" method="post">
                        ...
                        <div class="digit-group mt-4" data-group-name="digits" data-autosubmit="false" autocomplete="off">
                            ...
                            <input type="text" required id="digit-2" name="digit_2" data-next="digit-3"
                                data-previous="digit-1" />
                            <input type="text" required id="digit-3" name="digit_3" data-next="digit-4"
                                data-previous="digit-2" />
                            <input type="text" required id="digit-4" name="digit_4" data-next="digit-5"
                    ...
                    <div class="text-muted text-center">
                        {{ __("Don't Send A Code?") }}<a
                            href="{{ url('pharmacy_send_otp') }}">{{ __('Send Code Again') }}</a>
                    </div>
