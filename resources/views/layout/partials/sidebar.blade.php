    ...
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            ...
            @if (auth()->user()->hasRole('super admin'))
                <a href="{{ url('/home') }}">
                    ...
                    @else
                        <img src="{{ url('/assets/image/favicon-dcoteur2.png') }}" width="180" height="45"
                            alt="Logo" style="object-fit: contain;" />
                    @endif
                </a>
        ...
        <ul class="sidebar-menu">
            ...
            @if (auth()->user()->can('patient_access') || auth()->user()->can('admin_user_access'))
                ...
                <li
                    class="{{ $activePage == 'patients' ? 'active' : '' }} || {{ $activePage == 'admin_users' ? 'active' : '' }}">
                        ...
                        <li
                            ...
                            <ul class="dropdown-menu">
                                <li class="{{ $activePage == 'subscription' ? 'active' : '' }}">
                                    <a class="nav-link"
                                        href="{{ url('subscription') }}">{{ __('subscription') }}</a>
                                </li>
            ...
            @can('report_access')
                <li
                    class="{{ $activePage == 'user_report' ? 'active' : '' }} || {{ $activePage == 'doctor_report' ? 'active' : '' }}">
                    <a href="javascript:void(0)" class="nav-link has-dropdown">
