...
@section('content')
                                                ...
                                                @foreach ($test_reports as $test_report)
                                                    <tr
                                                        ...
                                                        <td class="text-sm px-6 py-4 font-fira-sans">
                                                            {{ $test_report->lab['name'] }}</td>
                                                        <td class="text-sm px-6 py-4 font-fira-sans">
                                                            @if ($test_report->prescription != null)
                                                                <a href="{{ 'report_prescription/upload/' . $test_report->prescription }}"
                                                                    data-fancybox="gallery2">
                                                                    <img src="{{ 'report_prescription/upload/' . $test_report->prescription }}"
                                                                        alt="Feature Image" width="50px" height="50px">
                                                                </a>
                                                            @else
    ...
    <div class="fixed top-0 left-0 z-[1055] hidden h-full w-full overflow-y-auto overflow-x-hidden outline-none"
        id="exampleModalScrollable" tabindex="-1" aria-modal="true">
        <div
            ...
            <div
                ...
                <div
                    ...
                    <h5 class="text-xl font-medium leading-normal text-neutral-800 dark:text-neutral-200"
                        id="exampleModalScrollableLabel"> {{ __('Appointment Details') }}</h5>
                    <button type="button"
                        ...
                        data-modal-hide="exampleModalScrollable" data-te-ripple-color="light">
                ...
                <div class="relative overflow-y-auto p-4">
                    <table class="table min-w-full mt-4">
                        ...
                        <tr>
                            <td class="text-sm text-gray-600 px-2 py-2 text-left font-fira-sans">{{ __('patient name') }}
                            </td>
                        ...
                        <tr>
                            <td class="text-sm text-gray-600 px-2 py-2 text-left font-fira-sans">
                                {{ __('patient phone number') }}</td>
                            <td class="text-sm font-light px-2 py-2 font-fira-sans patient_phone"></td>
                        </tr>
                        <tr>
                            <td class="text-sm text-gray-600 px-2 py-2 text-left font-fira-sans">{{ __('patient age') }}
                            </td>
                            <td class="text-sm font-light px-2 py-2 font-fira-sans patient_age"></td>
                        </tr>
                        <tr>
                            <td class="text-sm text-gray-600 px-2 py-2 text-left font-fira-sans">{{ __('patient gender') }}
                            </td>
