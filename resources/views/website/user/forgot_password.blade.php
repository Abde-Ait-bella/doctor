    ...
    <div class="xl:w-3/4 mx-auto">
        ...
        <div
            ...
            <div class="2xl:w-2/4 xxsm:w-full">
                ...
                <h1 class="font-fira-sans leading-10 font-medium text-3xl">{{ __('Forgot Password For Patient Account') }}
                </h1>
                <form action="{{ url('/user_forget_password') }}" method="post">
                    ...
                    <div class="pt-5">
                        ...
                        <input name="email"
                            ...
                            placeholder="{{ __('Enter email') }}" required type="email">
                        @error('email')
                    ...
                    <div class="pt-10">
                        <button type="submit"
                            class="font-fira-sans text-white bg-primary w-full text-sm font-normal py-3">{{ __('Send Email') }}</button>
                        <h1 class="font-fira-sans font-medium text-sm leading-5 pt-4 text-center text-primary text-normal">
                            <a href="{{ url('/patient-login') }}">{{ __('Remember Password?') }} </a>
                        </h1>
                    </div>
                </form>
            </div>
