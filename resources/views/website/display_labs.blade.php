    ...
    @foreach ($data as $lab)
        <div class="mainDiv border border-white-light">
            <div class="mainDiv1 p-10 1xl:h-[350px] xxmd:h-[300px] xmd:h-[300px] msm:h-[300px]">
                <img class="border-2 border-primary rounded-full p-0.5 m-auto w-36 h-36"
                    src="{{ url($lab['fullImage']) }}" alt="" />
                ...
                @else
                    <p class="font-normal leading-4 text-sm text-gray text-center font-fira-sans md:text-md py-2">
                        {{ __('@') }} {{ __('login to view') }} </p>
                @endif
                <p class="font-normal leading-4 text-sm text-primary text-center md:text-md"><i
                        class="fa-solid fa-door-open text-primary"></i> {{ __('Opens At') }} {{ $lab['openTime'] }}</p>
            </div>

            <div
                class="hoverDoc bg-white shadow-2xl p-5 relative hover:z-50 xxsm:w-full xxsm:h-[500px] xsm:h-[450px] md:h-[300px] xlg:w-[285px] lg:h-[300px] lg:overflow-y-auto xl:w-[255px] 1xl:h-[350px] 1xl:overflow-y-auto 1xl:w-[500px] 2xl:w-[560px]">
                <div class="flex items-center xxsm:flex-col md:flex-row lg:flex-col 1xl:flex-row 1xl:mt-10">
                    ...
                    <div
                        class="xxsm:w-full xsm:w-full 1xl:w-[60%] xlg:w-full md:w-[60%] lg:w-full xxsm:pl-0 xmd:pl-10 xxsm:ml-0 xlg:pl-0 lg:ml-0 lg:pl-0 1xl:pl-5 md:pl-5 md:border-l-2 md:border-white-light xxsm:border-l-0 lg:border-l-0 xl:border-l-0 xl:pl-0 1xl:border-l-2 h-[200px]">
                        <div>
                            <div
                                ...
                                @if (auth()->user())
                                    <p class="font-fira-sans font-normal text-sm leading-4 text-gray text-left"><span><i
                                                class="fa-solid fa-phone"></i></span> {{ $lab['user']['phone'] }}</p>
                                    <p
                                ...
                                @else
                                    <p class="font-fira-sans font-normal text-sm leading-4 text-gray text-left"><span><i
                                                class="fa-solid fa-phone"></i></span> {{ __('login to view') }}</p>
                                    <p
                                        class="font-fira-sans font-normal msm:text-sm xxsm:text-xs leading-4 text-gray text-left py-2">
                            ...
                            <div
                                ...
                                <a href="{{ url('lab_test/' . $lab['id'] . '/' . Str::slug($lab['name'])) }}"
                                    class="font-fira-sans text-white bg-primary hover:bg-primary text-sm text-center py-2.5 px-5">{{ __('Test Report') }}</a>
                            </div>
                        </div>
                    </div>
                </div>
