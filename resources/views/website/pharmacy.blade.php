    ...
    <div class="pt-14 border-b border-gray-light mb-10 pb-10">
        ...
        xxsm:space-y-2 xxsm:p-2">
                <div class="relative">
                    ...
                    <input type="search" name="search_pharmacy" id="search_pharmacy"
                        class="block p-2 pl-10 text-sm bg-white-50 border border-white-light 2xl:w-96 xmd:w-72 !sm:w-36 h-12"
                        placeholder="{{ __('Search Pharmacy...') }}" required>
                </div>
                    ...
                    <div>
                        ...
                        <div class="form-check p-1">
                            <input
                                ...
                                name="select_specialist" type="checkbox" value="popular" id="popular">
                            <label
                                class="form-check-label font-fira-sans font-normal text-sm leading-4 inline-block text-gray-800"
                                for="popular">
                                {{ __('Popular') }}
                            </label>
                        </div>
