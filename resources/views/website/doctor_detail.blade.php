            ...
            <div
                ...
                <div class="lg:w-[70%] xmd:w-[60%]  border-r border-white-light">
                    ...
                    <div class="border-b border-white-light pb-14">
                        <h1 class="text-xl font-medium leading-6 font-fira-sans text-black pt-6">{{ __('Certificate') }}
                        </h1>
                ...
                <div class="lg:w-[30%] xmd:w-[40%] border-b-0 mb-10 border-white-light ml-2">
                    <div class="xmd:pl-[10px] pt-6 xxsm:pl-0">
                        <h1 class="text-xl font-normal leading-6 font-fira-sans text-black pb-4">{{ __('Availablity') }}
                        </h1>
                            ...
                            <div
                                ...
                                <div class="">
                                    <h1 class="text-base font-fira-sans leading-5 font-normal text-black"><span
                                            class="text-primary">{{ __('Today • ') }}</span> {{ $today_date[0] }}</h1>
                            ...
                            @foreach ($reviews as $review)
                                <div class="ml-10">
                                    <div class="flex justify-between">
                                        <div class="flex">
                                            <img src="{{ $review->user['fullImage'] }}" class="w-10 h-10 rounded-full"
                                                alt="">
                                            <div class="ml-2">
