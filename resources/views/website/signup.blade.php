    ...
    <div class="xl:w-3/4 mx-auto">
        <div class="flex justify-between pt-20 pb-20 gap-10 lg:flex-row xxsm:flex-col xxsm:mx-5 xl:mx-0 2xl:mx-0">
            <div class="bg-slate-100 2xl:w-2/4 xxsm:w-full">
                <h1 class="font-fira-sans leading-10 font-medium text-3xl px-5 p-5 ml-5">
                    {{ __('Find the best doctor and medicine for you.') }}</h1>
                <div class="">
            ...
            <div class="2xl:w-2/4 xxsm:w-full">
                ...
                <div class="pt-5 flex">
                    ...
                    @else
                        ...
                        @endphp
                    @endif
                    <div data-attr="doctor"
                        class="signupDiv w-1/3 cursor-pointer py-1 ml-2 border border-[#D8D8D8] {{ $active == 'doctor' ? 'active' : '' }}">
                        <input {{ $active == 'doctor' ? 'checked' : '' }} id="bordered-radio-1" type="radio"
                            value="doctor" name="signup_title"
                            class="border-[#D8D8D8] cursor-pointer signup_title ml-2 text-blue-600">
                        <label for="bordered-radio-1" class="text-sm font-medium text-[#666666]">{{ __('Doctor') }}</label>
                    </div>
                    <div data-attr="patient"
                        class="signupDiv w-1/3 cursor-pointer py-1 ml-2 border border-[#D8D8D8] {{ $active == 'patient' ? 'active' : '' }}">
                        <input {{ $active == 'patient' ? 'checked' : '' }} id="bordered-radio-2" type="radio"
                            value="patient" name="signup_title"
                            class="border-[#D8D8D8] cursor-pointer signup_title ml-2 text-blue-600">
                        <label for="bordered-radio-2"
                            class="text-sm font-medium text-[#666666]">{{ __('Patient') }}</label>
                    </div>
                </div>
                <div class="tab-content contentDisplay" id="tabs-tabContent">
                    <div class="{{ $active == 'doctor' ? 'active' : 'hide' }} doctorDiv">
                        <form action="{{ url('doctorRegister') }}" method="post">
                            ...
                            <div class="pt-3">
                                <label
                                    class="font-fira-sans text-black text-sm font-normal">{{ __('Doctor Name') }}</label>
                            ...
                            <div class="pt-3">
                                ...
                                <div class="relative mb-3" data-te-datepicker-init data-te-input-wrapper-init
                                    ...
                                    <input name="doc_dob" value="{{ old('doc_dob') }}" placeholder="yyyy-mm-dd"
                                        class="@error('doc_dob') is-invalid @enderror w-full text-sm font-fira-sans text-gray block p-2 z-20"
                            ...
                            <div class="pt-3">
                                <div class="flex items-center mb-5">
                                    <label for="email"
                                        class="font-fira-sans text-black text-sm font-normal">{{ __('Gender') }}</label>
                            ...
                            <div class="pt-3">
                                ...
                                <h1 class="font-fira-sans font-medium text-sm leading-5 pt-4 text-center">
                                    ...
                                    <a href="{{ url('patient-login') }}"
                                        class="text-primary text-normal">{{ __('Login') }}</a>
                                </h1>
                            </div>
                        </form>
                    </div>
                    <div class="{{ $active == 'patient' ? 'active' : 'hide' }} patientDiv">
                        <form action="{{ url('signUp') }}" method="post">
                            ...
                            <div class="pt-3">
                                <label
                                    class="font-fira-sans text-black text-sm font-normal">{{ __('Patient Name') }}</label>
                            ...
                            <div class="pt-3">
                                ...
                                <div class="relative mb-3" data-te-datepicker-init data-te-input-wrapper-init
                                    data-te-format="yyyy-mm-dd">
                                    <input name="dob" value="{{ old('dob') }}" placeholder="yyyy-mm-dd"
