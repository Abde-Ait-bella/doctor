...
@section('content')
        ...
        <div class="">
            <div class="pt-10">
                ...
                <p class="py-5 font-fira-sans font-medium text-base text-center leading-5 text-blue">{{ $blog->blog_ref }}
                    <span class="text-gray font-normal leading-5">•
    ...
    <div class="mb-10">
        <div class="flex justify-center mb-10">
            <img src="{{ asset($blog->fullImage) }}"
                class="w-[67%] object-fill xxsm:h-[200px] xsm:h-[300px] sm:h-[400px] xxmd:h-[500px] lg:h-[700px]"
                alt="Logo">
        </div>
