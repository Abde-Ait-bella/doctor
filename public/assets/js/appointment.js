        ...
        success: function (result) {
            if (result.success == true) {
                ...
                $(data).each(function (index) {
                    ...
                    var ele = $(".displayHospital").find(
                        ".displayKm" + single_data["id"]
                    );
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            if (result.data.length > 0) {
                ...
                $(".timeSlotRow").html(
                    '<strong class="text-red-600 text-bs text-center w-100">At this time doctor is not availabel please change the date.</strong>'
                );
            }
            // $('.timeSlotRow').html('');
            // if (result.data.length > 0)
...
function changeHospital(i) {
    ...
    $("input[name=hospital_id]").val(
        $.trim($(".hospital" + i).attr("data-attribute"))
    );
